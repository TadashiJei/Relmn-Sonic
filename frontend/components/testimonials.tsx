...
const testimonials = [
  {
    ...
    body: "Publishing my research insights on Relmn has connected me with brilliant minds globally. The Fee Monetization rewards quality content beautifully.",
    img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Marcus Chen",
    username: "@marcus_crypto",
    body: "As a blockchain developer, Relmn's on-chain knowledge sharing is revolutionary. Every scribble I publish earns rewards while helping others learn.",
    img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Sarah Kim",
    username: "@sarahwrites",
    body: "The decentralized nature of Relmn means my expertise reaches the right audience without platform censorship. True knowledge freedom.",
    img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Prof. Ahmed Hassan",
    username: "@prof_ahmed",
    body: "Relmn's Sonic blockchain integration makes knowledge sharing lightning-fast. My students access insights instantly, anywhere in the world.",
    img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Lisa Thompson",
    username: "@lisa_learns",
    body: "Finding expert knowledge on Relmn is effortless. The quality of scribbles from verified Scribes has accelerated my learning journey.",
    img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "David Park",
    username: "@david_builds",
    body: "Relmn's Fee Monetization model finally rewards knowledge creators fairly. My technical insights now generate passive income while helping developers.",
    img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Dr. Maria Santos",
    username: "@maria_science",
    body: "The global reach of Relmn is incredible. My research findings now impact scientists across continents, all secured on-chain forever.",
    img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Alex Johnson",
    username: "@alex_innovates",
    body: "Relmn's decentralized knowledge network is the future. No middlemen, direct creator rewards, and permanent knowledge preservation.",
    img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&h=150&fit=crop&crop=face",
  },
  {
    name: "Dr. Raj Patel",
    username: "@raj_teaches",
    body: "Publishing educational content on Relmn connects me with curious minds worldwide. The blockchain ensures my knowledge lives forever.",
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-[540px]">
          ...
          <h2 className="from-foreground/60 via-foreground to-foreground/60 dark:from-muted-foreground/55 dark:via-foreground dark:to-muted-foreground/55 mt-5 bg-gradient-to-r bg-clip-text text-center text-4xl font-semibold tracking-tighter text-transparent md:text-[54px] md:leading-[60px] __className_bb4e88 relative z-10">
            What our Scribes say
          </h2>

          <p className="mt-5 relative z-10 text-center text-lg text-zinc-500">
            From researchers to developers, our global community of knowledge creators is transforming how expertise is
            shared and rewarded.
          </p>
        </div>
