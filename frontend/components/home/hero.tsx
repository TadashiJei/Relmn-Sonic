        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                The <strong>On-Chain</strong> <br />
                <strong>Knowledge</strong> <em className="italic">Network</em>
              </h1>
            </motion.div>
            ...
            >
              A decentralized, real-time knowledge ecosystem where experts ("Scribes") publish short-form insights
              ("Scribbles"). Every interaction is on-chain, leveraging Sonic's speed and Fee Monetization to reward
              creators.
            </motion.p>
          ...
          >
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-6">Powered by leading blockchain technologies</p>
              <div className="flex items-center justify-center gap-8">
                {/* Sonic Logo placeholder */}
                ...
                <div className="opacity-60 grayscale hover:opacity-100 hover:grayscale-0 hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.3)] transition-all duration-300">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M12 0L1.608 6v12L12 24l10.392-6V6L12 0zm-1.073 17.739L3.652 12l7.275-5.739L18.348 12l-7.421 5.739z" />
                  </svg>
                </div>
