            ...
            <div className="grid grid-cols-12 gap-4 justify-center">
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">On-Chain Publishing</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Publish your insights directly on the Sonic blockchain with immutable proof of authorship and
                      automatic Fee Monetization rewards.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="flex items-center gap-8">
                        ...
                        <div className="flex flex-col gap-3">
                          {["Scribbles", "Rewards", "Network"].map((item, index) => (
                            <motion.div
                              key={`left-${index}`}
                        ...
                        {/* Right Column */}
                        <div className="flex flex-col gap-3">
                          {["Experts", "Blockchain", "Community"].map((item, index) => (
                            <motion.div
                              key={`right-${index}`}
                              className="bg-white rounded px-3 py-2 flex items-center gap-2 text-black text-sm font-medium shadow-sm"
                              initial={{ opacity: 1, x: 0 }}
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Global Knowledge Network</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Connect with experts worldwide in a decentralized knowledge ecosystem. Access insights from any
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Fee Monetization</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Earn rewards automatically through our innovative Fee Monetization system. Get paid for your
                    ...
                    <div className="relative rounded-2xl border border-white/10 bg-black/20 dark:bg-white/5 backdrop-blur-sm">
                      <div className="p-4">
                        <textarea
                          ...
                          placeholder="Share your insights on-chain..."
                          value={inputValue}
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">Decentralized Architecture</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Built on Sonic blockchain for maximum security, transparency, and decentralization. No single
                      point of failure.
                    </p>
                  </div>
                </div>
